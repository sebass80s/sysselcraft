-- Ensure recurrence changes can materialize the current period immediately.
-- The original one-time occurrence is normalized to the recurrence period key
-- when it is still untouched, preventing duplicate "today" occurrences.
