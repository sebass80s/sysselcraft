 ...
 *
 * The stakes intentionally live here too. Before the first approved quest the site should read
 * as an empty, slightly neglected patch of village rather than an announced future building.
 */
