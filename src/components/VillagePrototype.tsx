...
export default function VillagePrototype() {
  ...
  return <section className="prototype-shell">
    ...
    {solSafeTestOpen && (() => {
      ...
      return <div className="sol-safe-test-overlay" role="presentation"><section className="sol-safe-test-panel" role="dialog" aria-modal="true" aria-label="Säkert test av Sol-story"><button className="close-button" onClick={() => setSolSafeTestOpen(false)} aria-label="Stäng test">×</button><span className="parent-menu-kicker">☀️ SOL STORY · SÄKERT TEST</span>
