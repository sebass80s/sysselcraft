...
export default function VillagePrototype() {
  ...
  return <section className="prototype-shell">
    ...
    {linusStoryMomentOpen && dialogueOpen && !recyclingStoryOpen && <div className="story-moment" role="presentation"><img src="/assets/village/story-moments/linus-first-meeting.png" alt="" /></div>}
